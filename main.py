...
class EntryWindow():
    def __init__(self, master):
        ...
        mainframe = Frame(master, bg='light blue').pack(expand=True, fill="both")

        # Create labels for every data entry
        Default_Label(mainframe, text=month).pack(padx=5, pady=5, side=TOP, anchor='n')
        v = IntVar()
        Radiobutton(mainframe, text="Inbetalning", font=14, variable=v, value=1, bg='light blue').pack(side=TOP,
                                                                                                       anchor='n',
                                                                                                       padx=50)
        Radiobutton(mainframe, text="Utbetalning", font=14, variable=v, value=2, bg='light blue').pack(side=TOP,
                                                                                                       anchor='n',
                                                                                                       padx=10)

        frame2 = Frame(master, bg='light blue').pack(expand=True, fill="both")
        ...
        frame3 = Frame(master, bg='light blue').pack(expand=True, fill="both")
        ...
        frame4 = Frame(master, bg='light blue').pack(expand=True, fill="both")
        ...
        # Back Button
        Default_Button(frame4, text="Tillbaka", command=MonthWindow).pack(pady=5)
